...
const HELP_ITEMS: HelpItem[] = [
  ...
  {
    title: "Играчи",
    body: "Овде е целиот состав на Јунајтед, поделен по позиции: голмани, одбрана, средина и напад. За секој играч стои бројот на дресот, возраста и од која земја е.",
  },
  {
    title: "Прашај",
